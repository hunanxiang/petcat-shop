# Petcat Shop Truffle Box

This box has all you need to reference our [Pet Shop tutorial](http://truffleframework.com/tutorials/pet-shop).
...
2. Download the box. This also takes care of installing the necessary dependencies.
    ```javascript
    truffle unbox hunanxiang/petcat-shop
    ```
